...
import sortReview from "../server/sendReview.js";
...
describe("sortReview()", () => {
  ...
  test("correct response format", async () => {
    const result = await sortReview(mockApiAdapter);
    ...
    return {
      data: [
        ...
        },
        {
          ...
          attributes: {
            comment:
              "Japanska versionen är perfekt, alla dubbade versioner är katastrof.",
            rating: 5,
            author: "Noel",
            verified: true,
